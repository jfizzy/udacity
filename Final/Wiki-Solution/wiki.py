...
secret = 'lskkdy#(kal37046429djeunspufh#^!*('
...
class Handler(webapp2.RequestHandler):
    ...
    def initialize(self, *a, **kw):
        ...
        self.can_post = self.user and self.user.name == 'jamzory'
...
class Signup(Handler):
    ...
    def post(self):
        ...
        if not valid_password(self.password):
            ...
            params['error-verify'] = "Your passwords didn't match."
            have_error = True
...
class Page(db.Model):
    ...
    @staticmethod
    def parent_key(path): # this handles the wierdness from google app engine datastore lag
...
app = webapp2.WSGIApplication([
                               ...
                               (PAGE_RE, WikiPage)
                               ], debug=DEBUG) # Debugs when in dev mode
